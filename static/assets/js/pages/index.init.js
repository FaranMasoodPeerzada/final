...
!(function () {
  var d = !1,
    u = "users-chat",
    n = "static/assets/images/users/user-dummy-img.jpg",
    m = "users",
    s = window.location.origin + "/static/assets/js/dir/",
    f = "",
    v = 1;
  function a() {
  ...
  e("userchats.json", function (e, t) {
    null !== e
      ? console.log("Something went wrong: " + e)
      : (t[0].today.forEach(function (e, t) {
          var a = '<div class="avatar-xs"><span class="avatar-title rounded-circle bg-primary text-white"><span class="username">'+ e.name.slice(0, 2) +'</span><span class="user-status"></span></span></div>',
            s = e.messagecount
        ...
        t[0].yesterday.forEach(function (e, t) {
          var a = '<div class="avatar-xs"><span class="avatar-title rounded-circle bg-primary text-white"><span class="username">'+ e.name.slice(0, 2) +'</span><span class="user-status"></span></span></div>',
            s = e.messagecount
              ? '<div class="ms-auto"><span class="badge bg-dark-subtle text-reset rounded p-1">' +
                e.messagecount +
        ...
        t[0].previous.forEach(function (e, t) {
          var a = '<div class="avatar-xs"><span class="avatar-title rounded-circle bg-primary text-white"><span class="username">'+ e.name.slice(0, 2) +'</span><span class="user-status"></span></span></div>',
            s = e.messagecount
              ? '<div class="ms-auto"><span class="badge bg-dark-subtle text-reset rounded p-1">' +
                e.messagecount +
